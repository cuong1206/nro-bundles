...
namespace Assets.src.g
{
	internal class Mabu : Char
	{
        ...
        public void getData1()
        {
            ...
            int id = 102;
            string bundlePath = $"res/x4/effectdata/{id}/data.bytes";
            TextAsset asset = LoadAssetHelper.Load<TextAsset>(bundlePath);

            if (asset != null)
            {
                try
                {
                    data1.readData2FromAsset(asset);
                    data1.img = GameCanvas.loadImage($"/effectdata/{id}/img.png");
                }
            ...
            {
                Debug.LogWarning($"⚠️ Không tìm thấy asset bundle: {bundlePath}");
            }
        }
        ...
        public void getData2()
        {
            ...
            if (asset != null)
            {
                try
                {
                    data2.readData2FromAsset(asset);
                    data2.img = GameCanvas.loadImage($"/effectdata/{id}/img.png");
