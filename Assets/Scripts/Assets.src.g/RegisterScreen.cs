            ...
            if (GameCanvas.currentDialog == null)
            {
                ...
                if (GameCanvas.h > 160 && imgTitle != null)
                {
                    if (GameCanvas.ispaintLogoGif)
                    {
                        ...
                        // GameScr.paintGif(g, GameCanvas.hw, tfUsername.y - 40);
                        // GameScr.paintGif(g, (GameCanvas.hw - imgW) / 2, (tfUsername.y - imgH) / 2 - 50);
                        GameScr.paintGif(g, GameCanvas.hw - (imgW / 2), (tfUsername.y) - (imgH) - 20);
                    }
                    else
                    {
