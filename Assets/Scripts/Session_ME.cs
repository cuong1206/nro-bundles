...
public class Session_ME : ISession
{
	...
	private class MessageCollector
	{
		public void run()
		{
			...
			if (messageHandler != null)
			{
				if (currentTimeMillis() - timeConnected > 500)
				{
                    ...
                    Cout.println("thoi gian " +(currentTimeMillis() - timeConnected));
                }
				else
				{
        ...
        private Message readMessage2(sbyte cmd)
        {
            ...
            if (num6 >= 1024 * 1024)
            {
                double mb = (double)num6 / (1024 * 1024);
                mb = (int)(mb * 10) / 10.0;
                strRecvByteCount = mb.ToString("0.0") + "Mb";
            }
            else
            {
                double kb = (double)num6 / 1024;
                kb = (int)(kb * 10) / 10.0;
                strRecvByteCount = kb.ToString("0.0") + "Kb";
            }

            ServerListScreen.dungluong = strRecvByteCount;
