...
public class Controller : IMessageHandler
{
    ...
    public void onMessage(Message msg)
    {
        ...
        try
        {
            ...
            switch (msg.command)
            {
                ...
                case -95:
                    {
                        ...
                        if (b48 == 0)
                        {
                            ...
                            double num118 = msg.reader().readDouble();
                        ...
                        if (b48 == 2)
                        {
                            ...
                            double num122 = msg.reader().readDouble();
                        ...
                        if (b48 == 3)
                        {
                            ...
                            double num124 = msg.reader().readDouble();
                            @char = null;
                            ...
                            if (@char != null)
                            {
                                ...
                                if (mob != null)
                                {
                                    ...
                                    {
                                        GameScr.startFlyText("-" + Res.formatNumber2(num124), mob.x, mob.y - mob.h, 0, -2, mFont.ORANGE);
                                    }
                                }
                            }
                        }
                        ...
                        if (b48 == 5)
                        {
                            ...
                            double num126 = msg.reader().readDouble();
                            ...
                            {
                                GameScr.startFlyText("-" + Res.formatNumber2(num126), mob8.x, mob8.y - mob8.h, 0, -2, mFont.ORANGE);
                            }
                        }
                        if (b48 == 6)
                        {
                ...
                case -47:
                    {
                        ...
                        GameCanvas.panel.isMessage = false;
                        if (GameCanvas.panel.isSearchClan && !Bag.gI().isShow)
                        {
                            GameCanvas.panel.initTabClans();
                        }
                        break;
                ...
                case -107:
                    {
                        ...
                        for (int num57 = 0; num57 < num56; num57++)
                        {
                            ...
                            Char.myPetz().arrItemBody[num57].template = ItemTemplates.get(num58);
                ...
                case -36:
                    {
                        ...
                        Res.outz("cAction= " + b23);
                        if (b23 == 0)
                        {
                            int num52 = msg.reader().readUnsignedByte();
                            Char.myCharz().arrItemBag = new Item[num52];
                            GameScr.hpPotion = 0;
                            Res.outz("numC=" + num52);
                            for (int num53 = 0; num53 < num52; num53++)
                            {
                                ...
                                Char.myCharz().arrItemBag[num53] = new Item();
                                Char.myCharz().arrItemBag[num53].template = ItemTemplates.get(num54);
                                Char.myCharz().arrItemBag[num53].quantity = msg.reader().readInt();
                                Char.myCharz().arrItemBag[num53].info = msg.reader().readUTF();
                                Char.myCharz().arrItemBag[num53].content = msg.reader().readUTF();
                                Char.myCharz().arrItemBag[num53].indexUI = num53;
                                int num55 = msg.reader().readUnsignedByte();
                                if (num55 != 0)
                                {
                                    Char.myCharz().arrItemBag[num53].itemOption = new ItemOption[num55];
                                    for (int num56 = 0; num56 < Char.myCharz().arrItemBag[num53].itemOption.Length; num56++)
                                    {
                                        int num57 = msg.reader().readUnsignedByte();
                                        int param2 = msg.reader().readUnsignedShort();
                                        if (num57 != -1)
                                        {
                                            Char.myCharz().arrItemBag[num53].itemOption[num56] = new ItemOption(num57, param2);
                                        }
                                    }
                                    Char.myCharz().arrItemBag[num53].compare = GameCanvas.panel.getCompare(Char.myCharz().arrItemBag[num53]);
                                }
                                if (Char.myCharz().arrItemBag[num53].template.type == 11)
                                {
                                }
                                if (Char.myCharz().arrItemBag[num53].template.type == 6)
                                {
                                    GameScr.hpPotion += Char.myCharz().arrItemBag[num53].quantity;
                                }
                            }
                        }
                        if (b23 == 2)
                        {
                            ...
                            int quantity2 = Char.myCharz().arrItemBag[b24].quantity;
                            Char.myCharz().arrItemBag[b24].quantity = quantity;
                            if (Char.myCharz().arrItemBag[b24].quantity < quantity2 && Char.myCharz().arrItemBag[b24].template.type == 6)
                            {
                                GameScr.hpPotion -= quantity2 - Char.myCharz().arrItemBag[b24].quantity;
                            }
                            if (Char.myCharz().arrItemBag[b24].quantity == 0)
                            {
                                Char.myCharz().arrItemBag[b24] = null;
                            }
                        }
                        break;
                    }
                ...
                case -45:
                    {
                        ...
                        if (type == 4)
                        {
                            ...
                            if (playerId == Char.myCharz().charID)
                            {
                                ...
                                Char.myCharz().seconds = time - 1000;
                ...
                case -67:
                    {
                        ...
                        try
                        {
                            ...
                            Res.outz("request hinh icon = " + num179);
                            if (num179 == 3896)
                            {
                                Res.outz("SIZE CHECK= " + array19.Length);
                            }
                            SmallImage.imgNew[num179].img = createImage(array19);
                        }
                        catch (Exception)
                        {
                            array19 = null;
                            SmallImage.imgNew[num179].img = Image.createRGBImage(new int[1], 1, 1, bl: true);
                        }
                        if (array19 != null && mGraphics.zoomLevel > 1)
                        {
                            Rms.saveRMS(mGraphics.zoomLevel + "Small" + num179, array19);
                        }
                        break;
                    }
                /*  case -67:
                ...
                case 56:
                    {
                        ...
                        if (charID == Char.myCharz().charID)
                        {
                            ...
                            if (Char.myCharz().cTypePk != 4)
                            {
                                ...
                                {
                                    GameScr.startFlyText("-" + Res.formatNumber2(dameHit), @char.cx, @char.cy - @char.ch, 0, -3, flag3 ? mFont.FATAL : mFont.RED);
                                }
                            }
                        }
                        else
                        {
                            ...
                            @char.cHP = msg.reader().readDouble();
                            bool flag4 = false;
                            double dameHit1 = msg.reader().readDouble();
                            if (dameHit1 != 0)
                            {
                                @char.doInjure();
                            }
                            ...
                            if (@char.cTypePk != 4)
                            {
                                ...
                                {
                                    GameScr.startFlyText("-" + Res.formatNumber2(dameHit1), @char.cx, @char.cy - @char.ch, 0, -3, flag4 ? mFont.FATAL : mFont.ORANGE);
                                }
                            }
                        }
                        break;
                ...
                case 50:
                    {
                        ...
                        for (int num136 = 0; num136 < b47; num136++)
                        {
                ...
                case 54:
                    {
                        Time.timeScale = ModFunc.timeScale;
                        @char = GameScr.findCharInMap(msg.reader().readInt());
                        if (@char == null)
                        {
                            return;
                ...
                case -3:
                    {
                        ...
                        long num181 = msg.reader().readDouble();
                        if (b73 == 0)
                        {
                ...
                case -5:
                    {
                        ...
                        //    char15.isCanShow = msg.reader().readByte() == 1;
                ...
                case -9:
                    {
                        ...
                        if (mob9 != null)
                        {
                            ...
                            if (flag10)
                            {
                                GameScr.startFlyText("-" + Res.formatNumber2(dame), mob9.x, mob9.getY() - mob9.getH(), 0, -2, mFont.FATAL);
                            }
                            else if (dame == 0)
                            {
                                mob9.x = mob9.xFirst;
                            ...
                            {
                                GameScr.startFlyText("-" + Res.formatNumber2(dame), mob9.x, mob9.getY() - mob9.getH(), 0, -2, mFont.ORANGE);
                            }
                        }
                        break;
                    }
                ...
                case -12:
                    {
                        ...
                        try
                        {
                            ...
                            {
                                GameScr.startFlyText("-" + Res.formatNumber2(dameHit), mob9.x, mob9.y - mob9.h, 0, -2, mFont.FATAL);
                            }
                            else
                            {
                                GameScr.startFlyText("-" + Res.formatNumber2(dameHit), mob9.x, mob9.y - mob9.h, 0, -2, mFont.ORANGE);
                            }
        ...
        {
            Debug.Log("loi read msg o day ne " + ex40.StackTrace);
        }
        finally
        {
            msg?.cleanup();
        ...
        try
        {
            ...
            for (sbyte b = 0; b < num; b++)
            {
                Mob mob = new Mob(b,
                    ...
                    msg.reader().readByte(),
                    msg.reader().readByte(),
                    msg.reader().readDouble(), // HP
                    msg.reader().readByte(),
                    msg.reader().readDouble(), // MAX HP
    ...
    public void messageNotMap(Message msg)
    {
        ...
        {
            Cout.LogError("LOI TAI messageNotMap + " + msg.command + "chi tiet: " + (ex.StackTrace));
        }
        finally
        {
            msg?.cleanup();
                ...
                case 0:
                    {
                        ...
                        sbyte okbody = msg.reader().readByte();
                        Char.myCharz().itemsbodysize = okbody;
                        Char.myCharz().arrItemBody = new Item[okbody];
                        try
                        {
                            Char.myCharz().setDefaultPart();
                        ...
                        sbyte okbag = msg.reader().readByte();
                        Char.myCharz().itemsbagsize = okbag;
                        Char.myCharz().arrItemBag = new Item[okbag];
                        GameScr.hpPotion = 0;
                        ...
                        sbyte okbox = msg.reader().readByte();
                        Char.myCharz().itemsboxsize = okbox;

                        Char.myCharz().arrItemBox = new Item[okbox];
                        GameCanvas.panel.hasUse = 0;
                ...
                case 5:
                    {
                        ...
                        {
                            GameScr.startFlyText("+" + Res.formatNumber2(Char.myCharz().cHP - cHP) + " " + mResources.HP, Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch - 20, 0, -1, mFont.HP);
                            SoundMn.gI().HP_MPup();
                        ...
                        {
                            GameScr.startFlyText("-" + Res.formatNumber2(cHP - Char.myCharz().cHP) + " " + mResources.HP, Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch - 20, 0, -1, mFont.HP);
                        }
                        GameScr.gI().dHP = Char.myCharz().cHP;
                        if (GameScr.isPaintInfoMe)
                        {
                ...
                case 6:
                    {
                        ...
                        {
                            GameScr.startFlyText("+" + Res.formatNumber2(Char.myCharz().cMP - cMP) + " " + mResources.KI, Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch - 23, 0, -2, mFont.MP);
                            SoundMn.gI().HP_MPup();
                        ...
                        if (Char.myCharz().cMP < cMP)
                        {
                            GameScr.startFlyText("-" + Res.formatNumber2(cMP - Char.myCharz().cMP) + " " + mResources.KI, Char.myCharz().cx, Char.myCharz().cy - Char.myCharz().ch - 23, 0, -2, mFont.MP);
                        }
                        GameScr.gI().dMP = Char.myCharz().cMP;
                        if (GameScr.isPaintInfoMe)
                        {
