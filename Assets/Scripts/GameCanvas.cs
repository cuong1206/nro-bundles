...
public class GameCanvas : IActionListener
{
    ...
    public static string homeUrl = Main._43E1BAA76E204275696C64204D6F64204E676F6E202D2052E1BABB202D2055792054C3AD6E204C69C3AA6E2048E1BB87205A616C6F20432D552D4F2D4E2D47();

    // public static string IP = Main._4E726F2048616E5A693A7472756D7670732E64646E732E6E65743A31343434353A302C302C30(); 

    //  public static string IP = Main._4E726F2048616E5A693A7472756D7670732E64646E732E6E65743A31343434353A302C302C30();

    public static string IP = Main._4C6F63616C3A3132372E302E302E313A31343434353A302C302C30();

    public static string keyclient = Main._6676777365726466234552574756666676672766663B666470647765();

    public static bool ispaintLogoGif = false;

    public static bool isnewTab = true;

    public static bool isInventory = true;

    public static bool isShowDungluong = true;

    public static string VERSION2 = _322E342E362E382E30();

    /// 

    public static long timeNow = 0L;

    public static Image imgSlThoiVang;

    public static byte typeChiso = 2;
    ...
    public void initGame()
    {
        ...
        CustomBackground.SelectBackgrounds();
    ...
    //    while (GameCanvas.currentScreen == GameCanvas.loginScr)
    //    {
    ...
    //            while (server != ServerListScreen.ipSelect || !Session_ME.gI().isConnected())
    //            {
    ...
    // Token: 0x060002EB RID: 747 RVA: 0x00035398 File Offset: 0x00033598
    ...
    public static string getLinkBundle()
    {
#if UNITY_ANDROID
        return "https://github.com/cuong1206/nro-bundles/releases/latest/download/cuongdevAPK";
#elif UNITY_IOS
    return "https://github.com/cuong1206/nro-bundles/releases/download/latest/cuongdevIOS";
#elif UNITY_STANDALONE_WIN
        return "https://github.com/cuong1206/nro-bundles/releases/latest/download/cuongdevPC";
#elif UNITY_WEBGL
    return "https://github.com/cuong1206/nro-bundles/releases/latest/download/cuongdevPC";
#else
    return ""; // fallback nếu không rõ platform
#endif
    }
    /*public static string getLinkBundle()
    {
#if UNITY_ANDROID
        return GameCanvas.ConvertToDirectGoogleDriveLink("https://drive.google.com/file/d/1iGqZOqVXmMPfBb8qN8BOEyXdTEne3s6G/view?usp=sharing");
#elif UNITY_IOS
    return GameCanvas.ConvertToDirectGoogleDriveLink("https://drive.google.com/file/d/1iGqZOqVXmMPfBb8qN8BOEyXdTEne3s6G/view?usp=sharing");
#elif UNITY_STANDALONE_WIN
    return GameCanvas.ConvertToDirectGoogleDriveLink("https://drive.google.com/file/d/1oYbrIBanPEKi01CGHwPBRQhb6fVevkMr/view?usp=sharing");
#elif UNITY_WEBGL
    return GameCanvas.ConvertToDirectGoogleDriveLink("https://drive.google.com/file/d/WEBGL_FILE_ID/view?usp=sharing");
#else
    return ""; // fallback nếu không rõ platform
#endif
    }*/
    public static string ConvertToDirectGoogleDriveLink(string shareLink)
    {
        ...
        try
        {
            // Kiểm tra xem link có dạng "/file/d/{id}/..." không
            int startIndex = shareLink.IndexOf("/d/");
            if (startIndex == -1) return null;

            startIndex += 3; // bỏ qua "/d/"
            int endIndex = shareLink.IndexOf("/", startIndex);
            if (endIndex == -1) endIndex = shareLink.Length;

            string fileId = shareLink.Substring(startIndex, endIndex - startIndex);
    ...
    public static void OnPaintBgGameScr(mGraphics g)
    {

        if (CustomBackground.customBgs.Count > 0)
        {
    ...
    {
        homeUrl = "disanngocrong.com";

        IP = _44692053E1BAA36E204E67E1BB8D632052E1BB936E673A31342E3232352E3231332E32333A31343434353A302C302C30();

        keyclient = _7466545972347337574044684263426640407A6135516A();
    ...
    public void paintChangeMap(mGraphics g)
    {
        ...
        if (GameCanvas.ispaintLogoGif)
        {
            ...
            GameScr.paintGif(g, (w - imgW) / 2, h / 2 - imgH);
        }
        else
        {
            g.drawImageScale(ModFunc.imgLogoBig, (w - imgW) / 2, h / 2 - imgH, imgW, imgH);
        }
    ...
    public static int GetItemQuantity(int templateId)
    {
        int totalQuantity = 0;
    ...
    public static Image loadIMGNEW(string path)
    {
        TextAsset texture = Resources.Load("res/x4" + path) as TextAsset;
        Image result = null;
        result = Image.createImageNew(texture.bytes);
        try
        {
    ...
    public static Image loadImage(Image img, int percent)
    {
        Image result = null;
        try
        {

            result = Image.createImage(img);
            if (mGraphics.zoomLevel != 4)
            {
                resizeImage(result, percent);
            }
    ...
    public static void resizeImage(Image img, int percent)
    {
        int wx1 = ((img.w * percent) / 100) / 4;
        int hx1 = ((img.h * percent) / 100) / 4;
        int w = wx1 * mGraphics.zoomLevel;
        int h = hx1 * mGraphics.zoomLevel;
        img.texture = Resize(img.texture, w, h);
        img.w = img.texture.width;
    ...
    public static Image loadImage(string path)
    {
        ...
        {
            //  Cout.LogError("Loi load res: " + ex.ToString());
        }
        return result;
    }

    public static Image LoadImageFromRoot(string path, int percent)
    {
        path = Main.res + path;
        Image result = null;
        try
    ...
    public static string _44692053E1BAA36E204E67E1BB8D632052E1BB936E673A31342E3232352E3231332E32333A31343434353A302C302C30()
    {
    ...
    public static string _7466545972347337574044684263426640407A6135516A()
    {
        string tenHam = System.Reflection.MethodBase.GetCurrentMethod().Name;
        if (tenHam[0] == '_')
        {
    ...
    public static string _322E342E362E382E30()
    {
        string tenHam = System.Reflection.MethodBase.GetCurrentMethod().Name;
        if (tenHam[0] == '_')
        {
