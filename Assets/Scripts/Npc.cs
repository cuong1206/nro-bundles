...
public class Npc : Char
{
    ...
    {
        if ((!me || isPaintAura) && idAuraEff > -1 && (statusMe == 1 || statusMe == 6) && !GameCanvas.panel.isShow)
        {
    ...
    public new void paintName(mGraphics g)
    {
        ...
        if (template.npcTemplateId == 3)
        {
            if (Char.myCharz().npcFocus != null && Char.myCharz().npcFocus.Equals(this))
            {
                mFont.tahoma_7_yellow.drawString(g, "[" + template.npcTemplateId + "] " + template.name, cx, cy - ch - mFont.tahoma_7.getHeight() - 5, mFont.CENTER, mFont.tahoma_7_grey);
            }
            else
            {
                mFont.tahoma_7_yellow.drawString(g, "[" + template.npcTemplateId + "] " + template.name, cx, cy - ch - 3 - mFont.tahoma_7.getHeight(), mFont.CENTER, mFont.tahoma_7_grey);
            }
            dyEff = 60;
        }
        else
        {
            ...
            if (template.npcTemplateId == 50 || template.npcTemplateId == 51)
            {
                if (duahau != null)
                {
                    ...
                    if (Char.myCharz().npcFocus != null && Char.myCharz().npcFocus.Equals(this))
                    {
                        mFont.tahoma_7_yellow.drawString(g, "[" + template.npcTemplateId + "] " + template.name, cx, cy - ch - mFont.tahoma_7.getHeight() - num, mFont.CENTER, mFont.tahoma_7_grey);
                    }
                    else
                    {
                        mFont.tahoma_7_yellow.drawString(g, "[" + template.npcTemplateId + "] " + template.name, cx, cy - ch - 8 - mFont.tahoma_7.getHeight() - num + 16, mFont.CENTER, mFont.tahoma_7_grey);
                    }
                }
                return;
            }
            if (template.npcTemplateId == 6)
            {
                if (Char.myCharz().npcFocus != null && Char.myCharz().npcFocus.Equals(this))
                {
                    mFont.tahoma_7_yellow.drawString(g, "[" + template.npcTemplateId + "] " + template.name, cx, cy - ch - mFont.tahoma_7.getHeight() - 16, mFont.CENTER, mFont.tahoma_7_grey);
                }
                else
                {
                    mFont.tahoma_7_yellow.drawString(g, "[" + template.npcTemplateId + "] " + template.name, cx, cy - ch - 8 - mFont.tahoma_7.getHeight(), mFont.CENTER, mFont.tahoma_7_grey);
                }
                return;
            }
            if (TileMap.mapID != 51)
            {
                ...
                if (Char.myCharz().npcFocus != null && Char.myCharz().npcFocus.Equals(this))
                {
                    if (TileMap.mapID != 113)
                    {
                        ...
                        mFont.tahoma_7_yellow.drawString(g, "[" + template.npcTemplateId + "] " + template.name, cx + num3, cy - ch - mFont.tahoma_7.getHeight() - num2 + num4, mFont.CENTER, mFont.tahoma_7_grey);
                    }
                }
                else
                {
                    ...
                    if (TileMap.mapID != 113)
                    {
                        ...
                        mFont.tahoma_7_yellow.drawString(g, "[" + template.npcTemplateId + "] " + template.name, cx + num5, cy - ch - num2 - mFont.tahoma_7.getHeight() + num6, mFont.CENTER, mFont.tahoma_7_grey);
                    }
                }
            }
            dyEff = 65;
