...
namespace Mod.AccountManager
{
    internal class InGameAccountManager : mScreen
    {
        ...
        static Texture2D earthOverlay = LoadAssetHelper.Load<Texture2D>("InGameAccountManager/img/" + nameof(earthOverlay) + ".png");
        static Texture2D namekOverlay = LoadAssetHelper.Load<Texture2D>("InGameAccountManager/img/" + nameof(namekOverlay) + ".png");
        static Texture2D saiyanOverlay = LoadAssetHelper.Load<Texture2D>("InGameAccountManager/img/" + nameof(saiyanOverlay) + ".png");
        static Texture2D add = LoadAssetHelper.Load<Texture2D>("InGameAccountManager/img/" + nameof(add) + ".png");
        static Texture2D addMultiple = LoadAssetHelper.Load<Texture2D>("InGameAccountManager/img/" + nameof(addMultiple) + ".png");
        static Texture2D hide = LoadAssetHelper.Load<Texture2D>("InGameAccountManager/img/" + nameof(hide) + ".png");
        static Texture2D show = LoadAssetHelper.Load<Texture2D>("InGameAccountManager/img/" + nameof(show) + ".png");
        static Texture2D up = LoadAssetHelper.Load<Texture2D>("InGameAccountManager/img/" + nameof(up) + ".png");
        static Texture2D down = LoadAssetHelper.Load<Texture2D>("InGameAccountManager/img/" + nameof(down) + ".png");
        static Texture2D help = LoadAssetHelper.Load<Texture2D>("InGameAccountManager/img/" + nameof(help) + ".png");
        ...
        internal static void OnStart()
        {
            ...
            {
                img = Image.createImageRGBA32(add.width, add.height),
                imgFocus = new Image(),
            ...
            {
                img = Image.createImageRGBA32(show.width, show.height),
                imgFocus = new Image(),
            ...
            {
                img = Image.createImageRGBA32(addMultiple.width, addMultiple.height),
                imgFocus = new Image(),
            ...
            {
                img = Image.createImageRGBA32(help.width, help.height),
                imgFocus = new Image(),
            ...
            {
                img = Image.createImageRGBA32(up.width, up.height),
                imgFocus = new Image(),
            ...
            {
                img = Image.createImageRGBA32(down.width, down.height),
                imgFocus = new Image(),
