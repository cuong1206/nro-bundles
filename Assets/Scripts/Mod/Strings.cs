...
namespace Mod.R
{
    ...
    {
        internal static readonly string DEFAULT_IP_SERVERS = "Nro HanZi:trumvps.ddns.net:14445:0,0,0";
     //  internal static readonly string DEFAULT_IP_SERVERS = "LOCAL:127.0.0.1:14445:0,0,0";
        #region Fields
        ...
        internal static string textzone = "";
        ...
        internal static string autoHoiSinh = "";
        ...
        static void LoadLanguageVI()
        {
            ...
            petLostMaster = $" [{mResources.pet} bị lạc sư phụ]";
