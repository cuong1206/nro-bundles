...
public class SoundMn
{
    ...
    public void GetStrModFunc()
    {
        ...
        {
            (ModFunc.GI().isHighFps ? text : text2) + ModFunc.strHighFps,
            (ModFunc.GI().isUpdateZones ? text : text2) + ModFunc.strUpdateZones,
            (ModFunc.GI().showCharsInMap ? text : text2) + ModFunc.strCharsInMap,
            (ModFunc.GI().showInfoMe ? text : text2) + ModFunc.strInfoMe,
            (ModFunc.GI().isAutoPhaLe ? text : text2) + ModFunc.strAutoPhaLe,
            (ModFunc.GI().isAutoVQMM ? text : text2) + ModFunc.strAutoVQMM,
            (ModFunc.GI().autoWakeUp ? text : text2) + ModFunc.strAutoWakeUp,
            (ModFunc.isAutoLogin ? text : text2) + ModFunc.strAutoLogin,
            (ModFunc.GI().isShowButton ? text : text2) + ModFunc.strShowButton,
            (ModFunc.isInventory ? text : text2) + ModFunc.strNewInventory
        };
    }
